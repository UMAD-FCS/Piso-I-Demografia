...
base        <- readxl::read_excel("Data/Base Motor Demografica.xlsx")
...
#===============================================================================
g1 <- 
    base %>% filter(NOMINDICADOR == "Tasas Específicas de Fecundidad por edad simple (por mil)"&FECHA==1996|FECHA==2000|FECHA==2005|FECHA==2010|FECHA==2015|FECHA==2019|FECHA==2024) %>%
  mutate(VALOR = as.numeric(VALOR)) %>%
