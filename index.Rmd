...
Fuente: Unidad de Métodos y Acceso a Datos (UMAD) (FCS-UdelaR) con base en Ministerio de Salud Pública e Instituto Nacional de Estadísticas (Proyecciones de Población 1996-2025. Rev. 2013)
...
#===============================================================================
g1 <- 
    base %>% filter(NOMINDICADOR == "Tasas Específicas de Fecundidad por edad simple (por mil)"&FECHA==1996|FECHA==2000|FECHA==2005|FECHA==2010|FECHA==2015|FECHA==2019|FECHA==2022) %>%
  mutate(VALOR = as.numeric(VALOR)) %>%
...
Fuentes: Unidad de Métodos y Acceso a Datos (UMAD) (FCS-UdelaR) con base en Ministerio de Salud Pública 
